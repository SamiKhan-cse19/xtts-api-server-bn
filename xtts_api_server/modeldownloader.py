...
def download_model(this_dir,model_version):
    ...
    files_to_download = {
         "config.json": "https://huggingface.co/intelsense/xttsv2-ft-bn-v3/resolve/main/config.json",
         "model.pth": "https://huggingface.co/intelsense/xttsv2-ft-bn-v3/resolve/main/model.pth",
         "vocab.json": "https://huggingface.co/intelsense/xttsv2-ft-bn-v3/resolve/main/vocab.json",
         "speakers_xtts.pth": "https://huggingface.co/intelsense/xttsv2-ft-bn-v3/resolve/main/speakers_xtts.pth"
    }
